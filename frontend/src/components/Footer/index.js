				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<ul class="list-unstyled">
							...
							<li><a href="#"><span class="fa fa-chevron-right mr-2"></span>Web Application</a></li>
							<li><a href="#"><span class="fa fa-chevron-right mr-2"></span>Mobile Application</a></li>
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon fa fa-map marker"></span><span class="text">Satelite Town, Gujranwala, Pakistan</span></li>
								<li><a href="#"><span class="icon fa fa-phone"></span><span class="text">+92 316 7429529</span></a></li>
								<li><a href="mailto:asadking066@gmail.com" target="_blank"><span class="icon fa fa-paper-plane pr-4"></span><span class="text">asadking066@gmail.com</span></a></li>
							</ul>
						</div>
						<ul class="ftco-footer-social list-unstyled mt-2">
							
							<li class="">
								<a target="_blank" href="https://www.fiverr.com/asadking066">
									<span><iconify-icon icon="jam:fiverr" style={{marginTop: "10px"}}></iconify-icon></span>
								</a>
							</li>
							<li class="">
								<a target="_blank" href="https://www.upwork.com/freelancers/~01fc75605863f33479">
									<span><iconify-icon icon="simple-icons:upwork" style={{marginTop: "10px"}}></iconify-icon></span>
								</a>
							</li>
